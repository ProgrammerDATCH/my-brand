...
const showDashboard = async () => {
    const res = await fetch(`${serverLink}/admin/dashboard`, {
        method: "GET",
        headers: {
    ...
    const dashboard = result.message;
    blogsCount.innerText = dashboard.blogs;
    suggestionsCount.innerText = dashboard.suggestions;
    usersCount.innerText = dashboard.users;
}
